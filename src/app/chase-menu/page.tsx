            ...
            <main className="min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900">
                ...
                <div className="relative overflow-hidden">
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 md:py-20">
                        ...
                        <Link
                            href={`/chase/${today}`}
                            className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg transition-[background-color,box-shadow,transform] duration-150 ease-out active:scale-[0.96] shadow-lg shadow-blue-600/25 hover:shadow-xl hover:shadow-blue-600/30 hover:-translate-y-0.5"
                        >
                            View Today&apos;s Menu
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 shadow-border">
                            ...
                            <div className="space-y-3 text-zinc-600 dark:text-zinc-400">
                                ...
                                <div className="flex justify-between">
                                    <span>Dinner</span>
                                    <span className="font-medium tabular-nums">4:30 PM - 9:00 PM</span>
                                </div>
