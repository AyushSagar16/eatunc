...
export default function NoMenuAvailable({
    ...
    const handleNavigateToNextDate = () => {
        if (nextAvailableDate) {
            ...
            push(`/${hallSlug}/${nextAvailableDate}`)
        }
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-6">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative size-12 md:w-16 md:h-16 shrink-0 rounded-xl overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800">
                            <Image
                    ...
                    >
                        <div className="px-8 py-12 md:px-12 md:py-16 rounded-[2.5rem] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col items-center">
                            ...
                            <m.div
                                ...
                                className="size-20 bg-blue-50 dark:bg-blue-900/20 rounded-3xl flex items-center justify-center mb-10"
                            >
                                <svg
